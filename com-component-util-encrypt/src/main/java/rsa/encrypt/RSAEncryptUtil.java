...
public class RSAEncryptUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String text = "welcome to HAHA!";

        String filePath = "C:/RSA";
        genKeyPair(filePath);

        String publicKeyString = loadPublicKeyByFile(filePath);
        String privateKeyString = loadPrivateKeyByFile(filePath);

        RSAPublicKey publicKey = loadPublicKeyByStr(publicKeyString);
        RSAPrivateKey privateKey = loadPrivateKeyByStr(privateKeyString);

        byte[] textE = encrypt(publicKey, text.getBytes());
        String textD = new String(decrypt(privateKey,textE));
